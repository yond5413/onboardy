...
import { Github, Code, FileText, ArrowRight, Loader2 } from 'lucide-react';
    ...
    <div className="max-w-4xl mx-auto space-y-8">
      <div>
        ...
        <p className="text-muted-foreground">
          Analyze a GitHub repository and generate system design documentation
        </p>
      </div>
      ...
      <Card className="border-2">
        <CardHeader>
          ...
          <CardDescription>
            Enter a GitHub repository URL to begin the analysis
          </CardDescription>
        </CardHeader>
        <CardContent>
